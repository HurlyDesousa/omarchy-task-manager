...
Panel {
                ...
                Column {
                    ...
                    Column {
                        ...
                        Label {
                            ...
                            text: "Local pi is excluded. Data from ~/.local/state/omarchy/agents/usage/ and omarchy agent usage-update when available."
    ...
    component AgentUsageCard: Column {
        ...
        Label {
            width: parent.width
            wrapMode: Text.WordWrap
            visible: !available || (agent.usageStatusText && agent.usageStatusText !== "")
            text: available
                ? (agent.usageStatusText || agent.authHelpText || "")
                : (agent ? (agent.usageStatusText || "unavailable") : "unavailable")
